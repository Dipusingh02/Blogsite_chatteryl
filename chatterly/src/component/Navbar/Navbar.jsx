...
<p onClick={() => navigate("/home")} className="headingall">Chatterly
<FaRocketchat className="chat-icon" /></p>
</div>
...
<ul>
<li id="mid"><Link to='/home'>Home</Link></li>
{isLoggedIn ? (
<li className="dropdown">
<span onClick={toggleDropdown} className="dropdown-toggle" id="end">
